...
?>
		...
		<p class="indhold_text">Her kan du se dine forskellige ordrer:</p>
...
// Her tjekkes først om man er logget ind og ellers kommer signup formen frem, så man kan registrere sig.
	...
	if (isset($_SESSION['id'])) {
		...
		$sql = "SELECT * FROM ordrer WHERE kunder_idKunder='$uid' AND Ordrer_Status='Ikke-betalt'";
		...
		echo "<a href='create-order.php' class='create-button'>Opret ny ordre</a><br><br>";
			...
			while ($row = $result->fetch_assoc()) {
				...
				echo "<div class='project-box'>
					...
					<p>Ordre Kunde:" . " " . $row['kunder_idKunder'] . "</p>
					...
					<form class='edit-form' method='POST' action='edit-order.php'>
						...
						<input type='hidden' name='OKunde' value='".$row['kunder_idKunder']."'>
						...
						<input type='hidden' name='OSamlet' value='".$row['Ordrer_SamletPris']."'>
