...
$sql = "SELECT * FROM kunder WHERE Kunde_Brugernavn='$uid'";

$result = mysqli_query($conn, $sql);

$row = mysqli_fetch_assoc($result);

$hash_pwd = $row['Kunde_Password'];
...
$sql = "SELECT * FROM kunder WHERE Kunde_Brugernavn='$uid' AND Kunde_Password='$hash_pwd'";
