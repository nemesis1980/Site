		...
		if (isset($_SESSION['id'])) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				echo "<div class='project-box'><p>Ordre id:" . " " . $row['idOrdrer'] . "</p>
					...
					<p>Ordre Kundenummer:" . " " . $row['kunder_idKunder'] . "</p>

					<p>Ordre Startdato:" . " " . $row['Ordrer_Billede1'] . "</p>

					<p>Ordre Startdato:" . " " . $row['Ordrer_Billede2'] . "</p>

					<p>Ordre Startdato:" . " " . $row['Ordrer_Billede3'] . "</p>

					<p>Ordre Startdato:" . " " . $row['Ordrer_Billede4'] . "</p>

					<p>Ordre Startdato:" . " " . $row['Ordrer_Billede5'] . "</p>
