...
$OKunde = (isset($_POST['OKunde']) ? $_POST['OKunde'] : null);
...
$OSamlet = (isset($_POST['OSamlet']) ? $_POST['OSamlet'] : null);

$OStatus = (isset($_POST['OStatus']) ? $_POST['OStatus'] : null);
...
*/
	...
	$result = mysqli_query($conn, $sql);
		...
		$sql = "UPDATE ordrer SET kunder_idKunder='$OKunde', Ordrer_Billede1='$OPic1', Ordrer_Billede2='$OPic2', Ordrer_Billede3='$OPic3', Ordrer_Billede4='$OPic4', Ordrer_Billede5='$OPic5', Ordrer_Startdato='$OStart', Ordrer_Slutdato='$OSlut', Ordrer_SamletPris='$OSamlet', Ordrer_Status='$OStatus' WHERE idOrdrer='$Oid'";
